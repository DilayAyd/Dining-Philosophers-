...
void pickUp(int philosopherNumber) {
	...
	//herhangi bir filazofun ilk olarak sağ çubuk ile başlaması çözümünde
	//sağ çubuğu alacak filazofu rastgele olarak belirliyoruz
    int rastgele;
	srand(time(NULL));
	rastgele=rand()%5;
	...
	//Eğer filazofun numarası rastgele seçilen filazof ile aynı ise
	//Filazof önce sağ çatalı alarak başlar
	if (philosopherNumber == rastgele) {
	...
	//Eğer filazofun numarası seçilmiş numara değil ise kurala uygun olarak 
	//önce sol çatalı alarak yemeğe başlar
	else {
